...
public class MapleSimSwerveDrivetrain {
  ...
  private static void regulateModuleConstantForSimulation(
    ...
    moduleConstants
        ...
        .withSteerMotorGains(
            new Slot0Configs()
                .withKP(SwerveConstants.steerKA)
                .withKI(SwerveConstants.steerKI)
                .withKD(SwerveConstants.steerKD)
                .withKS(SwerveConstants.steerKS)
                .withKV(SwerveConstants.steerKV)
                .withKA(SwerveConstants.steerKA)
