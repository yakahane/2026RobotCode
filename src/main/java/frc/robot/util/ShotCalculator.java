...
public class ShotCalculator {
    ...
    private static Transform2d robotToTurret = new Transform2d(TurretConstants.robotToTurret.toTranslation2d(), Rotation2d.kZero);
    ...
    public record ShootingParameters (
      ...
      public static ShootingParameters getParameters(Swerve swerve, Turret turret, double fieldAccelX, double fieldAccelY) {
    ...
    Angle turretAngle =
    turret.angleToFaceTarget(lookAheadPosition, swerve.getRobotPose());
